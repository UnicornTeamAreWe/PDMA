...
public class SoftwareController {
    ...
    public @ResponseBody void addItem(Software software) {
        softwareService.addItem(software);
    }

    @RequestMapping(value = "/updateSoftware")
    public @ResponseBody void updateItem(Software software) {
        softwareService.updateItem(software);
    }

    @RequestMapping(value = "/deleteSoftware")
    public @ResponseBody void deleteItem(SoftwareMultiKeys keys){
